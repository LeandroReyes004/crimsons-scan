          ...
          <>
                    ...
                    try {
                      ...
                      const config = [
                        ...
                        },
                        {
                          name: 'telegram',
                          label: 'Telegram',
                          color: 'hover:bg-[#26A5E4]/20 hover:text-[#26A5E4] hover:border-[#26A5E4]/30',
                          icon: (
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            {mangas.length === 0 ? (
              ...
              <div className="flex flex-col gap-10">
                {(() => {
                  const masLeidos = [...mangas].sort((a, b) => b.views_total - a.views_total).slice(0, 5);
                  return masLeidos.length > 0 ? (
                    <div className="flex flex-col gap-4">
                      <div className="flex items-center gap-2">
                        <span className="text-xl">🏆</span>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Top Más Leídos</h3>
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
                        {masLeidos.map(m => {
                          ...
                          return (
                            <MangaCard
                              key={m.id} id={m.id} slug={m.slug} title={m.titulo}
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Todas las Obras</h3>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6">
                    {mangas.map(m => {
                      let tags: string[] = [];
