      ...
      <div className="relative w-full pt-16 pb-8 px-4 md:px-8 bg-black border-b border-white/5">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto w-full flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-400 font-medium text-sm md:text-base">Tu colección personal. Solo lo que lees y te gusta.</p>
          </div>
        ...
        {!isAuthenticated ? (
          ...
          <div className="w-full flex flex-col items-center justify-center min-h-[300px] text-gray-500 bg-white/5 rounded-3xl border border-white/5">
            ...
            <p className="text-xl font-bold text-gray-300">
              {activeTab === 'marcadores' ? 'Aún no tienes mangas favoritos' : 'Aún no has leído nada'}
            </p>
            <p className="text-sm mt-1">
              Explora el catálogo para añadir historias a tu biblioteca.
            </p>
            <Link href="/catalogo" className="mt-6 bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-full font-semibold transition-colors">
              Ir al Catálogo
            </Link>
          </div>
        ) : (
