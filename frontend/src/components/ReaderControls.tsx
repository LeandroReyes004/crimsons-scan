...
export default function ReaderControls({
  ...
  return (
    <div className={`fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 sm:gap-4 bg-black/60 backdrop-blur-xl border border-white/10 px-3 sm:px-6 py-3 sm:py-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:bg-black/70 max-w-[calc(100vw-2rem)] ${
      !visible ? 'translate-y-24 opacity-0 pointer-events-none' : 'translate-y-0 opacity-100 pointer-events-auto'
    }`}>
      {/* Mode Switcher */}
